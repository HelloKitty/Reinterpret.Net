...
namespace Reinterpret.Net.NetFramework.Tests
{
	...
	public class CustomStructReinterpretCastTests
	{
		...
		public static void Test_Can_Reinterpret_Simple_ValueOnlyStruct(char charValue, int intValue)
		{
			...
			byte[] buffer = new byte[Marshal.SizeOf(typeof(TestCustomStruct1))];
			IntPtr ptr = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(TestCustomStruct1)));

			//act
			Marshal.StructureToPtr(testStructValue, ptr, false);
			Marshal.Copy(ptr, buffer, 0, Marshal.SizeOf(typeof(TestCustomStruct1)));
		...
		public unsafe static void Test_Can_Reinterpret_CustomStruct_Containing_Array(char charValue, int[] intValues)
		{
			...
			byte[] buffer = new byte[Marshal.SizeOf(typeof(TestCustomStruct2))];
			IntPtr ptr = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(TestCustomStruct2)));

			//act
			Marshal.StructureToPtr(testStructValue, ptr, false);
			Marshal.Copy(ptr, buffer, 0, Marshal.SizeOf(typeof(TestCustomStruct2)));
		...
		public unsafe static void Test_Can_Reinterpret_CustomStruct_Containing_String(char charValue, string stringValue)
		{
			...
			//act
			Marshal.StructureToPtr(testStructValue, ptr, false);
			Marshal.Copy(ptr, buffer, 0, Marshal.SizeOf(typeof(TestCustomStruct3)));
		...
		public unsafe static void Test_Can_Reinterpret_CustomStruct_Containing_RefType(char charValue, string stringValue)
		{
			...
			//act
			Marshal.StructureToPtr(testStructValue, ptr, false);
			Marshal.Copy(ptr, buffer, 0, Marshal.SizeOf(typeof(TestCustomStruct4)));
		...
		[TestCase('j', int.MinValue)]
		[TestCase((char)0, int.MaxValue)]
		public static void Test_Can_Reinterpret_From_ValueOnlyStruct(char charValue, int intValue)
		{
			//arrange
			TestCustomStruct1 testStructValue = new TestCustomStruct1() {c = charValue, i = intValue};
			...
			TestCustomStruct1 resultBackToStruct = result.Reinterpret<TestCustomStruct1>();

			//assert
			Assert.AreEqual(testStructValue.i, resultBackToStruct.i);
		...
		public unsafe static void Test_Can_Reinterpret_From_Containing_Array(char charValue, int[] intValues)
		{
			...
			//act
			byte[] result = testStructValue.Reinterpret();
			TestCustomStruct2 resultBackToStruct = result.Reinterpret<TestCustomStruct2>();

			//assert
			for(int i = 0; i < intValues.Length; i++)
				Assert.AreEqual(intValues[i], resultBackToStruct.i[i]);
			Assert.AreEqual(testStructValue.c, resultBackToStruct.c);
		}
		...
		public unsafe static void Test_Can_Reinterpret_From_Containing_String(char charValue, string stringValue)
		{
			...
			//act
			byte[] result = testStructValue.Reinterpret();
			TestCustomStruct3 resultBackToStruct = result.Reinterpret<TestCustomStruct3>();

			//assert
			Assert.NotNull(resultBackToStruct.s);
			Assert.AreEqual(stringValue, resultBackToStruct.s);
			Assert.AreEqual(testStructValue.c, resultBackToStruct.c);
		}
		...
		public unsafe static void Test_Can_Reinterpret_From_Containing_RefType(char charValue, string stringValue)
		{
			...
			//act
			byte[] result = testStructValue.Reinterpret();
			TestCustomStruct4 resultBackToStruct = result.Reinterpret<TestCustomStruct4>();

			//assert
			Assert.NotNull(resultBackToStruct.refType);
			Assert.AreEqual(stringValue, resultBackToStruct.refType.s);
			Assert.AreEqual(testStructValue.c, resultBackToStruct.c);
		}
